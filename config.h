...
#define STEP_DIRECTLY // control two steppers directly from the port pins

#define X1_STEP_BIT    2  // Uno Digital Pin 2
#define X2_STEP_BIT    3  // Uno Digital Pin 3
#define X3_STEP_BIT    4  // Uno Digital Pin 4
#define X4_STEP_BIT    5  // Uno Digital Pin 5
#define Y1_STEP_BIT    6  // Uno Digital Pin 6
#define Y2_STEP_BIT    7  // Uno Digital Pin 7
#define Y3_STEP_BIT    0  // Uno Digital Pin 8
#define Y4_STEP_BIT    5  // Uno Digital Pin 13

#define X1_STEP_PORT   PORTD // Uno Digital Pin 2
#define X2_STEP_PORT   PORTD // Uno Digital Pin 3
#define X3_STEP_PORT   PORTD // Uno Digital Pin 4
#define X4_STEP_PORT   PORTD // Uno Digital Pin 5
#define Y1_STEP_PORT   PORTD // Uno Digital Pin 6
#define Y2_STEP_PORT   PORTD // Uno Digital Pin 7
#define Y3_STEP_PORT   PORTB // Uno Digital Pin 8
#define Y4_STEP_PORT   PORTB // Uno Digital Pin 13

#define X1_STEP_DDR    DDRD // Uno Digital Pin 2
#define X2_STEP_DDR    DDRD // Uno Digital Pin 3
#define X3_STEP_DDR    DDRD // Uno Digital Pin 4
#define X4_STEP_DDR    DDRD // Uno Digital Pin 5
#define Y1_STEP_DDR    DDRD // Uno Digital Pin 6
#define Y2_STEP_DDR    DDRD // Uno Digital Pin 7
#define Y3_STEP_DDR    DDRB // Uno Digital Pin 8
#define Y4_STEP_DDR    DDRB // Uno Digital Pin 13

//Still needed for generating out_bits
...
#define MINIMUM_STEPS_PER_MINUTE 60 // (steps/min) - Integer value only
